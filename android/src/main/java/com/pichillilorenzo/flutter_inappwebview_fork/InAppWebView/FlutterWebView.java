...
public class FlutterWebView implements PlatformView, MethodCallHandler  {
  ...
  public FlutterWebView(BinaryMessenger messenger, final Context context, Object id, HashMap<String, Object> params, View containerView) {
    channel = new MethodChannel(messenger, "com.pichillilorenzo/flutter_inappwebview_fork_" + id);
    ...
    if (Shared.activity == null) {
      Log.e(LOG_TAG, "\n\n\nERROR: Shared.activity is null!!!\n\n" +
              ...
              "- Take a look at the \"IMPORTANT Note for Android\" section here: https://github.com/pichillilorenzo/flutter_inappwebview_fork#important-note-for-android\n" +
    ...
    // fix https://github.com/pichillilorenzo/flutter_inappwebview_fork/issues/182
    try {
