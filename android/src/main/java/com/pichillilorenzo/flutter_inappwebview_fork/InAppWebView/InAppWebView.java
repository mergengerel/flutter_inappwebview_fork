package com.pichillilorenzo.flutter_inappwebview_fork.InAppWebView;
...
import com.pichillilorenzo.flutter_inappwebview_fork.ContentBlocker.ContentBlocker;
import com.pichillilorenzo.flutter_inappwebview_fork.ContentBlocker.ContentBlockerAction;
import com.pichillilorenzo.flutter_inappwebview_fork.ContentBlocker.ContentBlockerHandler;
import com.pichillilorenzo.flutter_inappwebview_fork.ContentBlocker.ContentBlockerTrigger;
import com.pichillilorenzo.flutter_inappwebview_fork.InAppBrowser.InAppBrowserActivity;
import com.pichillilorenzo.flutter_inappwebview_fork.JavaScriptBridgeInterface;
import com.pichillilorenzo.flutter_inappwebview_fork.R;
import com.pichillilorenzo.flutter_inappwebview_fork.Shared;
import com.pichillilorenzo.flutter_inappwebview_fork.Util;
...
import static com.pichillilorenzo.flutter_inappwebview_fork.InAppWebView.PreferredContentModeOptionType.fromValue;
...
final public class InAppWebView extends InputAwareWebView {
  ...
  static final String variableForOnLoadResourceJS = "window._flutter_inappwebview_fork_useOnLoadResource";
  ...
  static final String variableForShouldInterceptAjaxRequestJS = "window._flutter_inappwebview_fork_useShouldInterceptAjaxRequest";
  ...
  static final String interceptAjaxRequestsJS = "(function(ajax) {" +
          ...
          "  ajax.prototype._flutter_inappwebview_fork_url = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_method = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_isAsync = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_user = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_password = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_password = null;" +
          "  ajax.prototype._flutter_inappwebview_fork_already_onreadystatechange_wrapped = false;" +
          "  ajax.prototype._flutter_inappwebview_fork_request_headers = {};" +
          ...
          "    this._flutter_inappwebview_fork_url = url;" +
          "    this._flutter_inappwebview_fork_method = method;" +
          "    this._flutter_inappwebview_fork_isAsync = isAsync;" +
          "    this._flutter_inappwebview_fork_user = user;" +
          "    this._flutter_inappwebview_fork_password = password;" +
          "    this._flutter_inappwebview_fork_request_headers = {};" +
          "    open.call(this, method, url, isAsync, user, password);" +
          "  };" +
          "  ajax.prototype.setRequestHeader = function(header, value) {" +
          "    this._flutter_inappwebview_fork_request_headers[header] = value;" +
          ...
          "        var ajaxRequest = {" +
          "          method: self._flutter_inappwebview_fork_method," +
          "          url: self._flutter_inappwebview_fork_url," +
          "          isAsync: self._flutter_inappwebview_fork_isAsync," +
          "          user: self._flutter_inappwebview_fork_user," +
          "          password: self._flutter_inappwebview_fork_password," +
          "          withCredentials: self.withCredentials," +
          "          headers: self._flutter_inappwebview_fork_request_headers," +
          ...
          "    var self = this;" +
          "    if (" + variableForShouldInterceptAjaxRequestJS + " == null || " + variableForShouldInterceptAjaxRequestJS + " == true) {" +
          "      if (!this._flutter_inappwebview_fork_already_onreadystatechange_wrapped) {" +
          "        this._flutter_inappwebview_fork_already_onreadystatechange_wrapped = true;" +
          ...
          "      var ajaxRequest = {" +
          "        data: data," +
          "        method: this._flutter_inappwebview_fork_method," +
          "        url: this._flutter_inappwebview_fork_url," +
          "        isAsync: this._flutter_inappwebview_fork_isAsync," +
          "        user: this._flutter_inappwebview_fork_user," +
          "        password: this._flutter_inappwebview_fork_password," +
          "        withCredentials: this.withCredentials," +
          "        headers: this._flutter_inappwebview_fork_request_headers," +
          ...
          "            var flutter_inappwebview_fork_value = self._flutter_inappwebview_fork_request_headers[header];" +
          "            if (flutter_inappwebview_fork_value == null) {" +
          "              self._flutter_inappwebview_fork_request_headers[header] = value;" +
          "            } else {" +
          "              self._flutter_inappwebview_fork_request_headers[header] += ', ' + value;" +
          "            }" +
          "            setRequestHeader.call(self, header, value);" +
          "          };" +
          "          if ((self._flutter_inappwebview_fork_method != result.method && result.method != null) || (self._flutter_inappwebview_fork_url != result.url && result.url != null)) {" +
          "            self.abort();" +
  ...
  static final String  variableForShouldInterceptFetchRequestsJS = "window._flutter_inappwebview_fork_useShouldInterceptFetchRequest";
