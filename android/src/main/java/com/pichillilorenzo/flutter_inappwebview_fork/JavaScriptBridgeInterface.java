...
import com.pichillilorenzo.flutter_inappwebview_fork.InAppWebView.FlutterWebView;
...
public class JavaScriptBridgeInterface {
  ...
  public static final String name = "flutter_inappwebview_fork";
  ...
  public void _callHandler(final String handlerName, final String _callHandlerID, final String args) {
    ...
    // https://github.com/pichillilorenzo/flutter_inappwebview_fork/issues/98
    final Handler handler = new Handler(Looper.getMainLooper());
    handler.post(new Runnable() {
      @Override
      public void run() {
