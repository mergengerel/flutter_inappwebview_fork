...
import com.pichillilorenzo.flutter_inappwebview_fork.CredentialDatabase.ProtectionSpace;
...
public class CredentialDatabaseHandler implements MethodChannel.MethodCallHandler {
  ...
  public CredentialDatabaseHandler(BinaryMessenger messenger) {
    channel = new MethodChannel(messenger, "com.pichillilorenzo/flutter_inappwebview_fork_credential_database");
