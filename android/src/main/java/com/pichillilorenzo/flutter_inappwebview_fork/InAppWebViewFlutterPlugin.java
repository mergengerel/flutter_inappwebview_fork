...
import com.pichillilorenzo.flutter_inappwebview_fork.InAppWebView.FlutterWebViewFactory;
...
public class InAppWebViewFlutterPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void onAttachedToEngine(FlutterPluginBinding binding) {
    ...
    //
    // See https://github.com/pichillilorenzo/flutter_inappwebview_fork/issues/390#issuecomment-647039084
    onAttachedToEngine(
  ...
  private void onAttachedToEngine(Context applicationContext, BinaryMessenger messenger, Activity activity, PlatformViewRegistry platformViewRegistry, FlutterView flutterView) {
    ...
    platformViewRegistry.registerViewFactory(
                    "com.pichillilorenzo/flutter_inappwebview_fork", new FlutterWebViewFactory(messenger, flutterView));
