        ...
        <script>
          window.addEventListener('flutterInAppWebViewPlatformReady', function(event) {
            fetch(new Request("http://${environment["NODE_SERVER_IP"]}:8082/test-download-file")).then(function(response) {
                window.flutter_inappwebview_fork.callHandler('fetchGet', response.status);
            }).catch(function(error) {
                window.flutter_inappwebview_fork.callHandler('fetchGet', "ERROR: " + error);
            });
            ...
            fetch("http://${environment["NODE_SERVER_IP"]}:8082/test-ajax-post", {
                ...
                response.json().then(function(value) {
					window.flutter_inappwebview_fork.callHandler('fetchPost', value);
				}).catch(function(error) {
				    window.flutter_inappwebview_fork.callHandler('fetchPost', "ERROR: " + error);
				});
            }).catch(function(error) {
                window.flutter_inappwebview_fork.callHandler('fetchPost', "ERROR: " + error);
            });
