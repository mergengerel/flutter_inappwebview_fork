...
let JAVASCRIPT_BRIDGE_NAME = "flutter_inappwebview_fork"
...
window.\(JAVASCRIPT_BRIDGE_NAME).callHandler = function() {
    var _windowId = window._flutter_inappwebview_fork_windowId;
...
let variableForOnLoadResourceJS = "window._flutter_inappwebview_fork_useOnLoadResource"
...
let variableForShouldInterceptAjaxRequestJS = "window._flutter_inappwebview_fork_useShouldInterceptAjaxRequest"
...
let variableForShouldInterceptFetchRequestsJS = "window._flutter_inappwebview_fork_useShouldInterceptFetchRequest"
    ...
    document.addEventListener('touchstart', function(event) {
        ...
        while (target) {
            if (target.tagName === 'IMG') {
                var img = target;
                window.flutter_inappwebview_fork._lastImageTouched = {
                    src: img.src
                };
                var parent = img.parentNode;
                while (parent) {
                    if (parent.tagName === 'A') {
                        window.flutter_inappwebview_fork._lastAnchorOrImageTouched = {
                ...
                window.flutter_inappwebview_fork._lastImageTouched = (img != null) ? {src: img.src} : window.flutter_inappwebview_fork._lastImageTouched;
                window.flutter_inappwebview_fork._lastAnchorOrImageTouched = {
...
public class InAppWebView: WKWebView, UIScrollViewDelegate, WKUIDelegate, WKNavigationDelegate, WKScriptMessageHandler, UIGestureRecognizerDelegate {
    ...
    public func prepare() {
        ...
        let userScript = WKUserScript(source: "window._flutter_inappwebview_fork_windowId = \(windowId == nil ? "null" : String(windowId!));" , injectionTime: .atDocumentStart, forMainFrameOnly: false)
